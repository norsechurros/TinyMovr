...
class TinyM:
    ...
    def __init__(self):
        ...
        self.tm3.controller.velocity.p_gain = 0.01 #initial no load param
        self.tm3.controller.velocity.i_gain = 0 #initial no load param
    ...
    def cmd_vel_clbk(self, msg):
        try:
            ...
            print("TM1: " + str(self.tm2.controller))
            print("                                                     ")
            print("-----------------------------------------------------")
            print("TM2: " + str(self.tm3.controller))
            print("                                                     ")
            print("-----------------------------------------------------")
            
            print("TM1 MOTOR: " + str(self.tm2.controller))
            print("                                                     ")
            print("-----------------------------------------------------")
            print("TM2 MOTOR: " + str(self.tm3.controller))
            print("                                                     ")
            print("-----------------------------------------------------")
